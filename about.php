					...
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							...
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Бал создан в 2016 году медленно наберал просмотры в начале кареры планировалось много видеороликов но в кокойто момент времени стало категорически не хватать
									 и конал перехал на стрименговый формат  <br>
									<br>
									 Хотелось бы сказать сразу что данный канал используется для стримов и создания видороликов как для учебы так и для любой возможной надобности меня или
									 любого моего знакомого.
								</p>
							</div>
						</div>
					</div>
					...
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							<div class='container-tx1-block darkmode-txt'>
								...
								<h2>Первое видео на канале</h2>
							</div>
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Первое видео которое было загружено на канал было "Школьник в танке"  <br>
									<br>
									 Видео было загружено в 2016 году и в нем я играл в танки с другом )
									 <br>
									 <br>
									 <br>
									 <br>
